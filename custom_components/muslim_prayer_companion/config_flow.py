...
DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Required("iqamah_method", default=DEFAULT_IQAMAH_METHOD): vol.In(
            ["offset", "api"]
        ),
        ...
        vol.Optional("iqamah_offsets", default=DEFAULT_IQAMAH_OFFSETS): {
            vol.Optional("Fajr", default=DEFAULT_IQAMAH_OFFSETS["Fajr"]): vol.Coerce(
                int
            ),
            vol.Optional("Dhuhr", default=DEFAULT_IQAMAH_OFFSETS["Dhuhr"]): vol.Coerce(
                int
            ),
            vol.Optional("Asr", default=DEFAULT_IQAMAH_OFFSETS["Asr"]): vol.Coerce(int),
            vol.Optional(
                "Maghrib", default=DEFAULT_IQAMAH_OFFSETS["Maghrib"]
            ): vol.Coerce(int),
            vol.Optional("Isha", default=DEFAULT_IQAMAH_OFFSETS["Isha"]): vol.Coerce(
                int
            ),
        },
